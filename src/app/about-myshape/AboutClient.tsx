    ...
    >
      <div className="space-y-32">
        ...
        <section className="max-w-4xl">
          <h2 className="text-white/30 text-[11px] tracking-[0.6em] uppercase mb-4 flex items-center gap-4">
        ...
        <section className="space-y-12">
          <h3 className="text-white/30 text-[11px] tracking-[0.6em] uppercase text-center">
              ...
              return (
                ...
                >
                  ...
                  <div className="decrypt-content relative z-10">
                    <div className="text-[#90c8ff]/70 text-[11px] tracking-[0.4em] font-mono mb-6 group-hover:text-[#90c8ff] transition-colors">
                      {principle.label}
                    </div>
                    <h4 className="text-white/70 text-[12px] tracking-[0.2em] uppercase mb-6 group-hover:text-white/90 transition-colors">
                      {principle.title}
                    </h4>
                    <p className="text-white/30 text-[11px] tracking-widest leading-relaxed uppercase group-hover:text-white/50 transition-colors">
                      {principle.content}
                    </p>
                  </div>
                </div>
          ...
          <div className="p-12 border relative z-10 transition-all duration-500 about-lab-panel">
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="flex flex-col gap-4 text-right min-w-[220px]">
                ...
                <span className="text-white/30 text-[11px] tracking-[0.2em]">EST. TIMESTAMP: 2024.09.12</span>
                {/* 频谱条 — 更冷的色调 */}
