...
Human—AI Gap: 0.3960`}
          ...
          <div className="space-y-3">
            {[
              ...
              { tag: "OVER_SMOOTHED", detail: "Muscle micro-perturbations missing — too perfect to be biological." },
            ].map(r => (
          ...
          <p>In a world where AI agents hold private keys, where deepfakes pass face recognition, where GPT-5 can generate convincing video of anyone doing anything — the only signal that cannot be forged is the real-time, physics-bound motion of a living human body.</p>
...
cargo run --release --bin myshape-demo -- --verbose`}
          ...
          <div className="flex flex-wrap gap-4 pt-4 text-[11px]">
            ...
            <a href="mailto:protocol@myshape.com" className="border px-4 py-2 text-cyan-400/60 hover:text-cyan-300 hover:border-cyan-400/40 transition-all" style={{ borderColor: "rgba(144,200,255,0.2)" }}>
