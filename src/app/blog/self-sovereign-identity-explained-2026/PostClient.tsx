      ...
      <main className="flex-1 relative">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 md:px-6" style={{ paddingTop: "8rem", paddingBottom: "6rem" }}>
          <div className="space-y-4 mb-16">
            <div className="flex items-center gap-4 text-[#90c8ff]/50 text-[11px] tracking-[0.3em] uppercase"><span>GENESIS 010</span><span className="w-8 h-[1px] bg-[#90c8ff]/20" /><span>2026.07.03</span>
