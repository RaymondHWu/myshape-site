    ...
    <div className="bg-[#02040a] text-[#f8feff] font-mono selection:bg-[#90c8ff]/30 min-h-screen flex flex-col">
      <ProtocolHeader /><main className="flex-1 relative"><BackgroundParticles />
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6" style={{paddingTop:"8rem",paddingBottom:"6rem"}}>
          <div className="space-y-4 mb-12"><div className="flex items-center gap-4 text-[#90c8ff]/50 text-[11px] tracking-[0.3em] uppercase"><span>GENESIS 020</span><span className="w-8 h-[1px] bg-[#90c8ff]/20" /><span>2026.07.03</span>
              <span className="w-8 h-[1px] bg-[#90c8ff]/20" />
              <span className="text-white/40">The Continuity Lab</span></div><h1 className="text-2xl md:text-4xl font-light tracking-[0.06em] text-white leading-tight">Digital Identity<br /><span className="text-[#90c8ff]">Standards 2026</span></h1><p className="text-white/35 text-[11px] tracking-[0.08em] leading-relaxed max-w-2xl">A complete map: W3C, ISO, IETF, eIDAS — how they fit together and what they mean for the future of identity.</p></div>
          <div className="overflow-x-auto mb-16"><table className="w-full text-[11px] tracking-[0.04em] border-collapse"><thead><tr className="border-b border-[#90c8ff]/10 text-left"><th className="py-3 px-3 text-[#90c8ff]/50 uppercase tracking-[0.12em] text-[11px]">Organization</th><th className="py-3 px-3 text-[#90c8ff]/50 uppercase tracking-[0.12em] text-[11px]">Standard</th><th className="py-3 px-3 text-[#90c8ff]/50 uppercase tracking-[0.12em] text-[11px]">Status</th><th className="py-3 px-3 text-[#90c8ff]/50 uppercase tracking-[0.12em] text-[11px]">Description</th></tr></thead><tbody>{STANDARDS.map(s=>(<tr key={s.name} className="border-b border-white/[0.03] hover:bg-white/[0.01]"><td className="py-3 px-3 text-[#90c8ff]/40 font-bold text-[11px]">{s.org}</td><td className="py-3 px-3 text-white/60 text-[11px]">{s.name}</td><td className="py-3 px-3 text-white/25 text-[11px]">{s.status}</td><td className="py-3 px-3 text-white/35 text-[11px] leading-relaxed">{s.desc}</td></tr>))}</tbody></table></div>
