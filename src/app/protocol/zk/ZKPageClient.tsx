      ...
      <div className="space-y-20 md:space-y-28">
        ...
        <section className="max-w-3xl">
          ...
          <p className="text-xl md:text-2xl font-light tracking-widest text-white leading-relaxed">
            Prove <span className="text-[#90c8ff]/90">presence</span> without revealing{" "}
            <span className="text-[#90c8ff]/90">identity</span>.
          </p>
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {PROOF_LAYERS.map((p, i) => (
              <div key={p.id} className="relative p-6 group transition-all duration-500"
                ...
                <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#90c8ff]/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                <div className="flex items-start gap-5">
                  <div className="w-14 h-14 flex items-center justify-center border border-[#90c8ff]/20 text-[#90c8ff]/70 font-mono text-[12px] tracking-[0.2em] shrink-0">
                    {p.id}
                  </div>
                  ...
                  {i < PROOF_LAYERS.length - 1 && (
                    <div className="hidden md:flex items-center text-[#90c8ff]/20 text-lg">↓</div>
                  )}
                </div>
              </div>
            ))}
            ...
            <div className="relative border p-6 text-center transition-all duration-500"
              style={{ borderColor: "rgba(144,200,255,0.15)", background: "transparent", boxShadow: "0 0 30px rgba(144,200,255,0.06)" }}
              ...
              <div className="text-[9px] tracking-[0.5em] uppercase mb-3" style={{ color: "rgba(144,200,255,0.5)" }} data-default="rgba(144,200,255,0.5)" data-hover="rgba(144,200,255,0.9)">Composite Proof</div>
              <div className="text-[14px] tracking-[0.4em] uppercase font-light"
                style={{ color: "rgba(165,243,252,0.8)", textShadow: "0 0 12px rgba(144,200,255,0.3)" }} data-default="rgba(165,243,252,0.8)" data-hover="rgba(165,243,252,1)">
            ...
            {VERIFICATION_RULES.map((r) => (
              <div key={r.rule} className="border p-5 group transition-all duration-500"
                ...
                <div className="flex items-center gap-3 mb-2">
                  <span className="w-5 h-5 flex items-center justify-center border border-[#90c8ff]/30 text-[#90c8ff]/60 font-mono text-[9px]">
                    {r.rule}
                  </span>
        ...
        <section className="border p-10 text-center transition-all duration-500"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <div className="text-[10px] tracking-[0.15em] mb-2" style={{ color: "rgba(144,200,255,0.6)" }} data-default="rgba(144,200,255,0.6)" data-hover="rgba(144,200,255,0.95)">Reveals Nothing</div>
            ...
            <div>
              <div className="text-[10px] tracking-[0.15em] mb-2" style={{ color: "rgba(144,200,255,0.6)" }} data-default="rgba(144,200,255,0.6)" data-hover="rgba(144,200,255,0.95)">Stores Nothing</div>
            ...
            <div>
              <div className="text-[10px] tracking-[0.15em] mb-2" style={{ color: "rgba(144,200,255,0.6)" }} data-default="rgba(144,200,255,0.6)" data-hover="rgba(144,200,255,0.95)">Leaks Nothing</div>
