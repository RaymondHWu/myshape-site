        ...
        <div className="space-y-32 pb-32 antialiased">
          ...
          <section className="max-w-3xl pt-10">
            ...
            <p className="text-xl md:text-3xl font-light tracking-[0.15em] text-white leading-tight uppercase">
              The Motion-to-ZK pipeline is the <span className="text-[#90c8ff] font-bold">computational spine</span> of the MyShape Protocol.
            </p>
          ...
          {/* --- NEW: 戰略橋接模塊 WHY_NOW --- */}
          <section className="max-w-2xl relative py-12 px-8 border-l border-[#90c8ff]/30 bg-gradient-to-r from-[#90c8ff]/[0.03] to-transparent">
            <h3 className="text-[#90c8ff]/50 text-[10px] tracking-[0.6em] uppercase mb-6 font-bold flex items-center gap-2">
              <span className="w-2 h-2 bg-[#90c8ff]/40 rounded-full animate-pulse" />
            ...
            <div className="space-y-4 font-mono">
              ...
              <p className="text-[#90c8ff] text-[14px] tracking-[0.3em] leading-relaxed uppercase font-bold">
              ...
              {pipelineSteps.map((item) => (
                <div key={item.step} className="group flex flex-col items-center text-center"
                  ...
                  <div className="w-16 h-16 rounded-full border border-white/10 bg-[#02040a] flex items-center justify-center mb-8 group-hover:border-[#90c8ff] transition-all duration-700 relative">
                    ...
                    <div className="absolute inset-[-4px] border-[1px] border-[#90c8ff]/0 border-t-[#90c8ff]/40 rounded-full opacity-0 group-hover:opacity-100 group-hover:rotate-[360deg] transition-all duration-[1500ms] ease-in-out" />
                  </div>
          ...
          <section className="bg-white/[0.01] border border-white/5 p-12 relative overflow-hidden group"
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#90c8ff]/5 blur-[80px] rounded-full -translate-y-1/2 translate-x-1/2" />
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
              ...
              <div className="flex flex-col items-center md:items-end gap-3 text-center md:text-right">
                <span className="px-3 py-1 bg-[#90c8ff]/10 border border-[#90c8ff]/20 text-[#90c8ff] text-[9px] tracking-[0.3em] font-bold">
          ...
          <section className="py-10 space-y-4 max-w-2xl mx-auto">
            <div className="border border-[#90c8ff]/15 bg-[#90c8ff]/[0.02] p-6 group cursor-default transition-all duration-500"
              onMouseEnter={e => { playTick(500, "sine", 0.04, 0.01); e.currentTarget.style.borderColor = "rgba(144,200,255,0.5)"; e.currentTarget.style.boxShadow = "0 0 30px rgba(144,200,255,0.08)"; }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(144,200,255,0.15)"; e.currentTarget.style.boxShadow = "none"; }}>
              <div className="text-[#90c8ff]/40 group-hover:text-[#90c8ff]/70 text-[8px] tracking-[0.3em] uppercase mb-3 font-mono transition-colors">◈ Protocol Note: Replay Defense</div>
            ...
            <div className="border border-[#90c8ff]/10 bg-[#90c8ff]/[0.01] p-5 group cursor-default transition-all duration-500"
              onMouseEnter={e => { playTick(450, "sine", 0.03, 0.01); e.currentTarget.style.borderColor = "rgba(144,200,255,0.35)"; e.currentTarget.style.boxShadow = "0 0 20px rgba(144,200,255,0.05)"; }}
          ...
          <section className="py-20 border-y border-white/5 text-center space-y-12">
              ...
              >
                 <div className="px-16 py-6 border border-[#90c8ff]/30 bg-[#90c8ff]/5 group-hover:bg-[#90c8ff] group-hover:text-black transition-all duration-500 text-[#90c8ff] text-[11px] tracking-[0.6em] uppercase font-bold shadow-[0_0_30px_rgba(6,182,212,0.05)]">
