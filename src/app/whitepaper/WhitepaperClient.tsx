...
Layer 4 — VS-001 Verification Session: The session layer aggregates confidence across all engines, applies an escalation strategy when evidence is ambiguous, and issues a single verdict. If any layer is inconclusive, the pipeline escalates rather than silently passing.
...
The output is a CPS-0001 Continuity Receipt — an engine-independent, Ed25519-signed JSON object that any conformant verifier can validate through V₁–V₆.`,
  },
  {
    ...
    content: `The following results were generated by the reference verifier against the CPS-0001 conformance suite and the 4-layer pipeline:
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mb-28">
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              <span className="text-white/10">|</span>
              <span className="text-white/25 text-[11px]">4-Layer Pipeline</span>
            </div>
          </div>
