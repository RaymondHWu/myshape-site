...
const sections = [
  ...
  { 
    ...
    content: [
      ...
      "Yet this self has no form of its own. It exists as fragments scattered across platforms, reconstructed by algorithms, and interpreted through models that do not belong to the individual. It is powerful but unanchored, present but unprotected. The digital self has become real, but it has not become sovereign."
    ]
  },
  { 
    id: 'V04', 
  ...
  { 
    ...
    content: [
      ...
      "MyShape envisions a world where every person carries a digital form that belongs only to them: a multidimensional construct generated locally, expressed selectively, and capable of interacting with autonomous systems on their behalf. This form is not a representation but a boundary—one that protects the individual while enabling them to participate fully in a world of distributed intelligence.",
    ...
    <div className="min-h-screen bg-[#02040a] text-[#f8feff] font-mono selection:bg-[#90c8ff]/30">
      ...
      <main className="relative z-10 pt-48 px-10 max-w-7xl mx-auto flex flex-col md:flex-row gap-24">
        ...
        <aside className="hidden md:block border-l border-white/5 pl-6" style={{
          position: "fixed", top: "192px", width: "256px",
