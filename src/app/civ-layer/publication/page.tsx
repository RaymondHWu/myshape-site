...
export default function PublicationPage() {
  const mediaChannels = [
    { id: "LOG_01", title: "Technical Announcements", desc: "DIRECT STREAM OF CORE PROTOCOL UPDATES, ARCHITECTURAL SHIFTS.", meta: "UPLINK: ACTIVE" },
    { id: "LOG_02", title: "Media & Press Kit", desc: "OFFICIAL ASSETS, BRAND GUIDELINES, AND VISUALIZATIONS.", meta: "ACCESS: PUBLIC" },
    { id: "LOG_03", title: "Community Intelligence", desc: "INSIGHTS FROM THE DECENTRALIZED IDENTITY ECOSYSTEM.", meta: "SIGNAL: STABLE" },
    { id: "LOG_04", title: "Civilizational Reports", desc: "LONG-FORM EXPLORATIONS INTO SOCIOLOGICAL IMPACT.", meta: "REF: CLASS_B" }
  ];
