...
import "./CivPapers.css";

export default function CivPapers() {
  const academicPapers = [
    ...
    {
      id: "PAPER_06",
      tag: "PROTOCOL_ARCHITECTURE",
      title: "MyShape Protocol: Five-Layer Architecture for Sovereign Identity",
      version: "V1.0",
      abstract: "The complete five-layer architecture: Capture, Geometry, Integrity, Proof, Identity.",
      locked: false
    },
    {
      id: "PAPER_10",
      tag: "CIVILIZATION_ROADMAP",
      title: "MyShape Civilization Roadmap: Four Epochs of Identity Evolution",
      version: "V1.0",
      abstract: "From Genesis Awakening to Universal Sovereignty — the four-epoch civilization vision.",
      locked: false
    }
  ];
