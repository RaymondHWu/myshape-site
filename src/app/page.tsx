...
export default function HomePage() {
  const [currentNode] = useState("roddog03");
  ...
  useEffect(() => {
    let i = 0;
    const fullText = currentNode.toUpperCase();
      ...
      <div className="fixed inset-0 z-[999] pointer-events-none">
        ...
        <div className="absolute bottom-10 right-10 text-right">
          <div className="flex flex-col items-end">
            ...
            {/* 节点 ID - 调至 12px 且更白 */}
            <div className="text-[12px] font-extralight text-white/90 tracking-[0.4em] uppercase leading-none mb-2">
              {displayText}
