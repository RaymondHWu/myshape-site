      ...
      <FaqJsonLd
        ...
        questions={[
          ...
          },
          {
            ...
            answer:
              "Proof of Continuity is the cryptographic primitive at the heart of MyShape. It verifies that the same sovereign entity has been continuously present over time — across sessions, devices, and agents — through a chain of signed presence receipts. Unlike a snapshot credential, continuity cannot be replayed or copied: it must be regenerated by a live, present entity.",
          },
          {
