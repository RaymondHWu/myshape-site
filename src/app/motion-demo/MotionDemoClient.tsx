        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          {phase === "complete" && pesData ? (
            <div className="flex flex-row gap-3">
              <div className="w-[42%] shrink-0 border border-white/10 bg-black/40 p-2.5 flex flex-col space-y-2">
              ...
              <div className="flex-1 border border-white/10 bg-black/40 p-2.5 flex flex-col space-y-2">
