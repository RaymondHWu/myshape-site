...
function ConsoleRow({
  ...
  const accentColor = {
    ...
    muted: { dot: "bg-white/10", val: "text-white/20", sub: "text-white/15" },
  ...
  return (
    <div className="flex items-center gap-2 group/row hover:bg-white/[0.015] px-3 py-1.5 -mx-3 transition-colors duration-500">
      ...
      <span className="text-white/20 text-[9px] tracking-[0.12em] uppercase font-mono shrink-0 w-[72px]">{label}</span>
    ...
    <div className="relative border border-cyan-400/[0.08] bg-gradient-to-b from-cyan-400/[0.015] to-transparent overflow-hidden"
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-white/[0.03]">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-white/35 text-[9px] tracking-[0.15em] uppercase font-mono">
            PROTOCOL_ENCLAVE
          </span>
          <span className="text-white/[0.08]">|</span>
          <span className={`text-[8px] tracking-[0.12em] uppercase font-mono ${hasNodes ? "text-green-400/60" : "text-white/15"}`}>
      ...
      <div className="px-5 py-2 border-b border-white/[0.02]">
        <div className="flex items-center gap-3">
          <span className="text-white/20 text-[7px] tracking-[0.15em] uppercase font-mono shrink-0">GENESIS_PROGRESS</span>
          ...
          <span className="text-amber-400/60 text-[7px] tracking-[0.1em] font-mono shrink-0">{genesisPct}%</span>
        </div>
      </div>
      ...
      {hasNodes ? (
        <div className="relative" style={{ height: "240px" }}>
          ...
          <div className="absolute top-4 right-4 text-right pointer-events-none">
            <div className="text-[7px] tracking-[0.25em] text-white/20 uppercase font-light">SCANS</div>
            <div className="text-[13px] font-mono text-cyan-400/60 tracking-[0.06em]">{data.totalScans}</div>
          </div>
