    ...
    <div className="flex flex-col items-center gap-3">
      ...
      <form onSubmit={handleNotify} className="flex items-center gap-2">
        <input
          ...
          disabled={sent}
          className="bg-transparent border-b border-white/[0.08] py-1.5 px-1 text-white/30 text-[10px] tracking-[0.08em] font-mono outline-none focus:border-[#90c8ff]/40 placeholder:text-white/12 disabled:opacity-40 w-48 text-center"
        />
        {!sent && (
          <button
            type="submit"
            className="text-[#90c8ff]/25 hover:text-[#90c8ff]/55 text-[9px] tracking-[0.2em] uppercase font-mono transition-colors"
          >
            →
          </button>
        )}
