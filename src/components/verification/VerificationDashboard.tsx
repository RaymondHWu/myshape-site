    ...
    <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
      ...
      <div className="vd-footer" onMouseEnter={() => playTick(500, "sine", 0.04, 0.01)}>
        <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
          {[{ label: "Engine", value: "v0.2.2 · 120 tests pass" }, { label: "Features", value: "K · A · J · J_spec (4/7 active)" }, { label: "Factors", value: "M(0.60) · D(0.25) · C(0.15)" }, { label: "Risk API", value: "LOW · MEDIUM · HIGH" }].map((s) => (
