...
export default function ProtocolStatus() {
  ...
  if (loading) {
    return (
      <div className="w-full border-t border-white/[0.03] bg-gradient-to-b from-white/[0.005] to-transparent">
  ...
  if (!status) {
    return (
      <div className="w-full border-t border-red-400/[0.04] bg-gradient-to-b from-red-400/[0.005] to-transparent">
  ...
  return (
    <div className="relative w-full border-t border-white/[0.03] bg-gradient-to-b from-white/[0.008] to-transparent"
      style={{ boxShadow: `inset 0 1px 0 rgba(34,211,238,${hasNodes ? 0.03 : 0.01})` }}>
