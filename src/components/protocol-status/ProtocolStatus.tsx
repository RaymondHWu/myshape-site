        ...
        <div className="flex flex-wrap items-center justify-center md:justify-between gap-x-6 gap-y-2">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="text-white/20 text-[9px] tracking-[0.15em] uppercase font-mono group-hover/status:text-white/40 transition-colors">
                PROTOCOL
              </span>
              <span className="text-cyan-400/60 text-[9px] tracking-[0.12em] uppercase font-mono group-hover/status:text-cyan-400/80 transition-colors">
                {status.status}
              </span>
            </div>
            ...
            >
              ...
              <span className="text-amber-400/60 text-[9px] tracking-[0.12em] uppercase font-mono group-hover/status:text-amber-400/80 transition-colors">
                {status.genesis_nodes}<span className="text-white/10">/100</span>
              </span>
              {status.cohort_sealed && (
                <span className="text-green-400/60 text-[7px] tracking-[0.2em] uppercase font-mono">SEALED</span>
              )}
          ...
          <div className="flex items-center gap-4">
            {status.last_scan && (
              ...
              >
                <span className="text-white/25 text-[8px] tracking-[0.12em] uppercase font-mono group-hover/status:text-white/40 transition-colors">
                  LAST_SCAN
                </span>
                <span className="text-white/25 text-[8px] tracking-[0.06em] font-mono group-hover/status:text-white/40 transition-colors">
                  {status.last_scan}
                </span>
              </div>
            )}
            ...
            <div className="flex items-center gap-2">
              <span className="text-white/10 text-[7px] tracking-[0.15em] uppercase font-mono">
                T+{(status.total_nodes * 7) || 0}d
              </span>
              <span className="text-white/10 text-[7px] tracking-[0.1em] uppercase font-mono">
