  ...
  return (
    <div className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-[#02040a] gap-8 px-6">
      <div className="text-center">
        ...
        <div className="font-mono text-[11px] tracking-[0.2em] text-[#90c8ff]/30 uppercase max-w-[400px] leading-relaxed whitespace-pre-line">
          {message}
        </div>
      </div>
      ...
      {onReset && (
        <button
          onClick={onReset}
          className="font-mono text-[11px] tracking-[0.3em] bg-transparent border border-[#90c8ff]/30 text-[#90c8ff] px-8 py-3 uppercase hover:bg-[#90c8ff]/10 hover:border-[#90c8ff] transition-all duration-400 cursor-pointer"
        >
          {resetLabel}
        </button>
      )}
