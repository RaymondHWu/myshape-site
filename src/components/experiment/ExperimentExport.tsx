      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-1">
          <button
            onClick={handleCopy}
            disabled={count === 0}
            className="px-3 py-1.5 border border-[#90c8ff]/30 text-[9px] text-[#90c8ff]/60 tracking-[0.1em] uppercase hover:border-[#90c8ff]/60 hover:text-[#90c8ff]/90 transition-all disabled:opacity-20 disabled:cursor-not-allowed"
          >
          ...
          {confirmClear ? (
            <>
              <button
                onClick={handleClear}
                className="px-3 py-1.5 border border-[#f85149]/40 text-[9px] text-[#f85149]/60 tracking-[0.1em] uppercase hover:border-[#f85149] transition-all"
              >
                Confirm
              </button>
              <button
                onClick={() => setConfirmClear(false)}
                className="px-3 py-1.5 border border-white/10 text-[9px] text-white/20 tracking-[0.1em] uppercase hover:border-white/25 transition-all"
              >
                Cancel
              </button>
            </>
            ...
            <button
              onClick={handleClear}
              disabled={count === 0}
              className="px-3 py-1.5 border border-white/10 text-[9px] text-white/15 tracking-[0.1em] uppercase hover:border-[#f85149]/30 hover:text-[#f85149]/50 transition-all disabled:opacity-20 disabled:cursor-not-allowed"
            >
