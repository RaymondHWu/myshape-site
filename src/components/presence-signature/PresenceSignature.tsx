    ...
    <div className="border border-[#90c8ff]/20 bg-gradient-to-b from-[#90c8ff]/[0.04] to-transparent p-4 font-mono space-y-2.5"
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#90c8ff]/90 text-[10px] tracking-[0.3em] uppercase font-bold">Presence Signature</span>
        </div>
      ...
      <div className="space-y-2">
        <div className="border-b border-white/[0.04] pb-1.5 flex justify-between items-center group hover:scale-[1.02] hover:bg-[#90c8ff]/[0.04] hover:border-[#90c8ff]/15 transition-all hover:text-white/80 duration-300 cursor-default rounded-sm px-1 -mx-1">
          ...
          <div className="text-[#90c8ff]/90 font-mono text-[9px] group-hover:text-[#90c8ff] tracking-[0.05em]">{presenceId}</div>
        </div>
        <div className="border-b border-white/[0.04] pb-1.5 flex justify-between items-center group hover:scale-[1.02] hover:bg-[#90c8ff]/[0.04] hover:border-[#90c8ff]/15 transition-all hover:text-white/80 duration-300 cursor-default rounded-sm px-1 -mx-1">
      ...
      <div className="flex gap-1.5 pt-2">
        <button onClick={handleDownload}
          ...
          className="flex-1 py-2 border border-[#90c8ff]/25 text-[#90c8ff]/70 text-[10px] tracking-[0.2em] uppercase hover:scale-[1.02] hover:bg-[#90c8ff]/[0.04] hover:text-[#90c8ff] transition-all hover:text-white/80">
          Download Proof
        </button>
        <button onClick={handleShare}
          onMouseEnter={() => playTick(700, "sine", 0.08, 0.02)}
          className="flex-1 py-2 border border-[#90c8ff]/15 text-white/40 text-[10px] tracking-[0.2em] uppercase hover:border-[#90c8ff]/30 hover:text-white/60 transition-all hover:text-white/80">
